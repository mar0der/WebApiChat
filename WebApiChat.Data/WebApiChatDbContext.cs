namespace WebApiChat.Data
{
    ...
    public class WebApiChatDbContext : IdentityDbContext<User>
    {
        ...
        public virtual IDbSet<GroupChat> GroupChats { get; set; }

        public virtual IDbSet<GroupMessage> GroupMessages { get; set; }

        public virtual IDbSet<GroupMessageReceiver> GroupMessageReceivers { get; set; }
